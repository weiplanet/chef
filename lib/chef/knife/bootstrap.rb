  ...
  class Knife
    class Bootstrap < Knife
      ...
      option :bootstrap_template,
        short: "-t TEMPLATE_PATH",
        long: "--bootstrap-template TEMPLATE_PATH",
      ...
      option :hint,
        ...
        proc: Proc.new { |h|
          config[:hints] ||= Hash.new
          name, path = h.split("=")
          config[:hints][name] = path ? Chef::JSONCompat.parse(::File.read(path)) : Hash.new
        }
      ...
      option :bootstrap_vault_item,
        ...
        proc: Proc.new { |i|
          ...
          config[:bootstrap_vault_item][vault] ||= []
          config[:bootstrap_vault_item][vault].push item
          config[:bootstrap_vault_item]
        }
